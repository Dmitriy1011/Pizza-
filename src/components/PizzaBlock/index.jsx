...
function PizzaBlock({id, name, imageUrl, price, types, sizes, onClickAddPizza, addedCount}) {
    ...
    const onAddPizza = () => {
      const obj = {
          ...
          imageUrl,
          price,
          size: availableSizes[activeSize], //по индексу выбираем размер
          type: availableTypes[activeType], //по индексу выбираем тип(название (тонкая или традиционная))
      };
      onClickAddPizza(obj);
    }

    //стараться создавать меньше анонимных функци (то есть без константы)
...
<Button 
    onClick = {onAddPizza} className = "button--add" outline>
<svg
 width="12"
 height="12"
 viewBox="0 0 12 12"
...
PizzaBlock.propTypes = {
  ...
  onClickAddPizza: PropTypes.func, //говорим, что onAddPizza является функцией
